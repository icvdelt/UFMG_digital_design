...
proc create_properties {requirements} {
    ...
    if {$k == 2} {
        ...
        set check_properties [linsert $check_properties end [assert {not i_end_codeword and DUT.RS_CONTROL.r_state=START_CODEWORD ##1 i_valid and not i_end_codeword and not i_start_codeword and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS[*K-3] ##1 i_valid and  i_end_codeword and not i_start_codeword and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS ##1 DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS and (not i_valid or (not i_start_codeword and not i_end_codeword))|=> DUT.RS_CONTROL.r_state=GENERATE_PARITY}  -name REQ_RS_ENC_005.CHECK.05]]
        set check_properties [linsert $check_properties end [assert {i_end_codeword and DUT.RS_CONTROL.r_state=START_CODEWORD ##1 i_valid and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS and (not i_valid or (not i_start_codeword and not i_end_codeword))|=> DUT.RS_CONTROL.r_state=GENERATE_PARITY}  -name REQ_RS_ENC_005.CHECK.06]]
    ...
    set check_properties [linsert $check_properties end [assert {not(i_end_codeword) ##1 DUT.RS_CONTROL.r_state=START_CODEWORD and i_valid and i_end_codeword and not(i_start_codeword) |=> DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS} -name REQ_RS_ENC_006.CHECK.01]]
        set check_properties [linsert $check_properties end [assert {i_end_codeword ##1 DUT.RS_CONTROL.r_state=START_CODEWORD and i_valid and not (i_end_codeword) and not(i_start_codeword) |=> DUT.RS_CONTROL.r_state=GENERATE_PARITY} -name REQ_RS_ENC_006.CHECK.02]]
    if {$k == 2} {
    ...
    set check_properties [linsert $check_properties end [assert {DUT.RS_CONTROL.r_state=START_CODEWORD and not(i_valid) and $past(not(i_end_codeword)) |=> DUT.RS_CONTROL.r_state=STALL} -name REQ_RS_ENC_006.CHECK.04]]
...
#   Covers
    ...
    if {$k == 2} {
        ...
        set cover_properties [linsert $cover_properties end [cover {not i_end_codeword and DUT.RS_CONTROL.r_state=START_CODEWORD ##1 i_valid and not i_end_codeword and not i_start_codeword and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS[*K-3] ##1 i_valid and  i_end_codeword and not i_start_codeword and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS ##1 DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS and (not i_valid or (not i_start_codeword and not i_end_codeword))|=> DUT.RS_CONTROL.r_state=GENERATE_PARITY}  -name REQ_RS_ENC_005.COVER.05]]
        set cover_properties [linsert $cover_properties end [cover {i_end_codeword and DUT.RS_CONTROL.r_state=START_CODEWORD ##1 i_valid and DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS and (not i_valid or (not i_start_codeword and not i_end_codeword))|=> DUT.RS_CONTROL.r_state=GENERATE_PARITY}  -name REQ_RS_ENC_005.COVER.06]]
    ...
    set cover_properties [linsert $cover_properties end [cover {not(i_end_codeword) ##1 DUT.RS_CONTROL.r_state=START_CODEWORD and i_valid and i_end_codeword and not(i_start_codeword) |=> DUT.RS_CONTROL.r_state=PROCESS_SYMBOLS} -name REQ_RS_ENC_006.COVER.01]]
        set cover_properties [linsert $cover_properties end [cover {i_end_codeword ##1 DUT.RS_CONTROL.r_state=START_CODEWORD and i_valid and not (i_end_codeword) and not(i_start_codeword) |=> DUT.RS_CONTROL.r_state=GENERATE_PARITY} -name REQ_RS_ENC_006.COVER.02]]
    set k [lindex [get_design_info -list parameter] 1]
    if {$k == 2} {
    ...
    set cover_properties [linsert $cover_properties end [cover {DUT.RS_CONTROL.r_state=START_CODEWORD and not(i_valid) and $past(not(i_end_codeword)) |=> DUT.RS_CONTROL.r_state=STALL} -name REQ_RS_ENC_006.COVER.04]]
